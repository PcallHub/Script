...
_G.TitleTextColor = Color3.fromRGB(0, 170, 255)
_G.ImageColor = Color3.fromRGB(255, 255, 255)
_G.LineThemeColor = Color3.fromRGB(0, 170, 255)
_G.TabTextColor = Color3.fromRGB(0, 170, 255)
_G.TabImageColor = Color3.fromRGB(0, 170, 255)
_G.TabThemeColor = Color3.fromRGB(0, 170, 255)
_G.SectionColor = Color3.fromRGB(0, 170, 255)
_G.SectionImageColor = Color3.fromRGB(255, 255, 255)
_G.SectionTextColor = Color3.fromRGB(0, 170, 255)
_G.SectionOn = Color3.fromRGB(0, 170, 255)

-- Windows --
function Blacklib:Window(title, gametitle)
    local osfunc = {}
    local osfunc2 = {}
    local titlefunc = {}    
    ...
    spawn(function()
        while task.wait() do
            titlefunc:Refresh("") wait(.4) titlefunc:Refresh(title) wait(.4)
        end
    end)
    -- End Windows --
